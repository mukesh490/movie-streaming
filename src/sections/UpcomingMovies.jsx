...
function UpcomingMoies() {
  const { movies, loading, error } = useMovies(getUpcomingMovies);
  ...
  return (
    <section id="upcomming" className="overflow-visible bg-black px-6 py-10">
      <div className="mx-auto max-w-7xl overflow-visible">
        ...
        <h2 className="mb-8 flex items-center gap-3 text-3xl font-bold text-white">
          ...
          <span>{MOVIES_HEADING.upcomming}</span>
        </h2>
